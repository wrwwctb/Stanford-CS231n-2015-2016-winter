import urllib, os, tempfile  #import urllib2, os, tempfile  # 2792650
...
def image_from_url(url):
  ...
  """
  try:
    f = urllib.request.urlopen(url)  # urllib2.urlopen(url)
    ...
    os.remove(fname)
    return img
  except urllib.error.URLError as e:  # urllib2.URLError
    print('URL Error: ', e.reason, url)
  except urllib.error.HTTPError as e:  # urllib2.HTTPError
